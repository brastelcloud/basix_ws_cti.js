...
module.exports = (function(env) {
	...
	var adjust_avatar = function(avatar, is_user, base_url) {
      ...
      if(is_user) {
			  return base_url + "basix/avatars/users/" + avatar;
      } else {
			  return base_url + "basix/avatars/end_users/" + avatar;
      }
		}
	};
    ...
    console.log(entity_name, "fields", fields)
		...
		if(['channel', 'channel_waiting', 'queued_channel', 'parked_channel'].includes(entity_name)) {
			...
			if(entity_info.tags) {
				entity_info.tags = entity_info.tags.split(";");
			}
