...
module.exports = (function(env) {
	...
	var process_msg = function(m) {
      ...
      console.log("field_spec", entity_name, info_fields);
		  	return;
			...
			if(m[2][0] == "bert" && m[2][1] == "nil") {
				...
				arr.forEach(function(X) {
					var info = create_entity_info(entity_name, X, info_fields, opts);
					infos[info[key]] = info;
				});
			}
			...
			var entity_name = m[1];
			var info = create_entity_info(entity_name, m[2], info_fields, opts);
			var event_name = m[3];
